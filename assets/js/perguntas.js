var estruturageral = {
    mensagemfinal: {
        positiva: {
            texto: [
                "Parabéns, você concluiu com sucesso o quiz.", "Esperamos que essa experiência tenha sido enriquecedora para o seu entendimento e que seja mais um passo em direção ao aprimoramento contínuo.", "Que bom que você participou! Até a próxima oportunidade de aprendizado."
            ],
